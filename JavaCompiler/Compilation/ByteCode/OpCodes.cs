...
// ReSharper disable InconsistentNaming
                ...
                public static OpCode aconst_null = new OpCode(OpCodeValue.aconst_null, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode iconst_m1 = new OpCode(OpCodeValue.iconst_m1, NormalizedOpCodeValues.iconst, -1, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode iconst_0 = new OpCode(OpCodeValue.iconst_0, NormalizedOpCodeValues.iconst, 0, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode iconst_1 = new OpCode(OpCodeValue.iconst_1, NormalizedOpCodeValues.iconst, 1, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode iconst_2 = new OpCode(OpCodeValue.iconst_2, NormalizedOpCodeValues.iconst, 2, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode iconst_3 = new OpCode(OpCodeValue.iconst_3, NormalizedOpCodeValues.iconst, 3, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode iconst_4 = new OpCode(OpCodeValue.iconst_4, NormalizedOpCodeValues.iconst, 4, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode iconst_5 = new OpCode(OpCodeValue.iconst_5, NormalizedOpCodeValues.iconst, 5, OpCodeMode.Simple, OpCodeModeWide.Unused, true);
                ...
                public static OpCode bipush = new OpCode(OpCodeValue.bipush, NormalizedOpCodeValues.iconst, OpCodeMode.Immediate_1, OpCodeModeWide.Unused, true);

                public static OpCode sipush = new OpCode(OpCodeValue.sipush, NormalizedOpCodeValues.iconst, OpCodeMode.Immediate_2, OpCodeModeWide.Unused, true);

                public static OpCode ldc = new OpCode(OpCodeValue.ldc, OpCodeMode.Constant_1, OpCodeModeWide.Unused, false);

                public static OpCode ldc_w = new OpCode(OpCodeValue.ldc_w, NormalizedOpCodeValues.ldc, OpCodeMode.Constant_2, OpCodeModeWide.Unused, false);

                public static OpCode ldc2_w = new OpCode(OpCodeValue.ldc2_w, NormalizedOpCodeValues.ldc, OpCodeMode.Constant_2, OpCodeModeWide.Unused, false);
                ...
                public static OpCode iload_0 = new OpCode(OpCodeValue.iload_0, NormalizedOpCodeValues.iload, 0, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode iload_1 = new OpCode(OpCodeValue.iload_1, NormalizedOpCodeValues.iload, 1, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode iload_2 = new OpCode(OpCodeValue.iload_2, NormalizedOpCodeValues.iload, 2, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode iload_3 = new OpCode(OpCodeValue.iload_3, NormalizedOpCodeValues.iload, 3, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode lload_0 = new OpCode(OpCodeValue.lload_0, NormalizedOpCodeValues.lload, 0, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode lload_1 = new OpCode(OpCodeValue.lload_1, NormalizedOpCodeValues.lload, 1, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode lload_2 = new OpCode(OpCodeValue.lload_2, NormalizedOpCodeValues.lload, 2, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode lload_3 = new OpCode(OpCodeValue.lload_3, NormalizedOpCodeValues.lload, 3, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode fload_0 = new OpCode(OpCodeValue.fload_0, NormalizedOpCodeValues.fload, 0, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode fload_1 = new OpCode(OpCodeValue.fload_1, NormalizedOpCodeValues.fload, 1, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode fload_2 = new OpCode(OpCodeValue.fload_2, NormalizedOpCodeValues.fload, 2, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode fload_3 = new OpCode(OpCodeValue.fload_3, NormalizedOpCodeValues.fload, 3, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode dload_0 = new OpCode(OpCodeValue.dload_0, NormalizedOpCodeValues.dload, 0, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode dload_1 = new OpCode(OpCodeValue.dload_1, NormalizedOpCodeValues.dload, 1, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode dload_2 = new OpCode(OpCodeValue.dload_2, NormalizedOpCodeValues.dload, 2, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode dload_3 = new OpCode(OpCodeValue.dload_3, NormalizedOpCodeValues.dload, 3, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode aload_0 = new OpCode(OpCodeValue.aload_0, NormalizedOpCodeValues.aload, 0, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode aload_1 = new OpCode(OpCodeValue.aload_1, NormalizedOpCodeValues.aload, 1, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode aload_2 = new OpCode(OpCodeValue.aload_2, NormalizedOpCodeValues.aload, 2, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode aload_3 = new OpCode(OpCodeValue.aload_3, NormalizedOpCodeValues.aload, 3, OpCodeMode.Simple, OpCodeModeWide.Unused, true);
                ...
                public static OpCode istore_0 = new OpCode(OpCodeValue.istore_0, NormalizedOpCodeValues.istore, 0, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode istore_1 = new OpCode(OpCodeValue.istore_1, NormalizedOpCodeValues.istore, 1, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode istore_2 = new OpCode(OpCodeValue.istore_2, NormalizedOpCodeValues.istore, 2, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode istore_3 = new OpCode(OpCodeValue.istore_3, NormalizedOpCodeValues.istore, 3, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode lstore_0 = new OpCode(OpCodeValue.lstore_0, NormalizedOpCodeValues.lstore, 0, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode lstore_1 = new OpCode(OpCodeValue.lstore_1, NormalizedOpCodeValues.lstore, 1, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode lstore_2 = new OpCode(OpCodeValue.lstore_2, NormalizedOpCodeValues.lstore, 2, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode lstore_3 = new OpCode(OpCodeValue.lstore_3, NormalizedOpCodeValues.lstore, 3, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode fstore_0 = new OpCode(OpCodeValue.fstore_0, NormalizedOpCodeValues.fstore, 0, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode fstore_1 = new OpCode(OpCodeValue.fstore_1, NormalizedOpCodeValues.fstore, 1, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode fstore_2 = new OpCode(OpCodeValue.fstore_2, NormalizedOpCodeValues.fstore, 2, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode fstore_3 = new OpCode(OpCodeValue.fstore_3, NormalizedOpCodeValues.fstore, 3, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode dstore_0 = new OpCode(OpCodeValue.dstore_0, NormalizedOpCodeValues.dstore, 0, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode dstore_1 = new OpCode(OpCodeValue.dstore_1, NormalizedOpCodeValues.dstore, 1, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode dstore_2 = new OpCode(OpCodeValue.dstore_2, NormalizedOpCodeValues.dstore, 2, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode dstore_3 = new OpCode(OpCodeValue.dstore_3, NormalizedOpCodeValues.dstore, 3, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode astore_0 = new OpCode(OpCodeValue.astore_0, NormalizedOpCodeValues.astore, 0, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode astore_1 = new OpCode(OpCodeValue.astore_1, NormalizedOpCodeValues.astore, 1, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode astore_2 = new OpCode(OpCodeValue.astore_2, NormalizedOpCodeValues.astore, 2, OpCodeMode.Simple, OpCodeModeWide.Unused, true);

                public static OpCode astore_3 = new OpCode(OpCodeValue.astore_3, NormalizedOpCodeValues.astore, 3, OpCodeMode.Simple, OpCodeModeWide.Unused, true);
                ...
                public static OpCode iinc = new OpCode(OpCodeValue.iinc, OpCodeMode.Local_1_Immediate_1, OpCodeModeWide.Local_2_Immediate_2, true);
                ...
                public static OpCode if_icmpeq = new OpCode(OpCodeValue.if_icmpeq, OpCodeMode.Branch_2, OpCodeModeWide.Unused, true);

                public static OpCode if_icmpne = new OpCode(OpCodeValue.if_icmpne, OpCodeMode.Branch_2, OpCodeModeWide.Unused, true);

                public static OpCode if_icmplt = new OpCode(OpCodeValue.if_icmplt, OpCodeMode.Branch_2, OpCodeModeWide.Unused, true);

                public static OpCode if_icmpge = new OpCode(OpCodeValue.if_icmpge, OpCodeMode.Branch_2, OpCodeModeWide.Unused, true);

                public static OpCode if_icmpgt = new OpCode(OpCodeValue.if_icmpgt, OpCodeMode.Branch_2, OpCodeModeWide.Unused, true);

                public static OpCode if_icmple = new OpCode(OpCodeValue.if_icmple, OpCodeMode.Branch_2, OpCodeModeWide.Unused, true);

                public static OpCode if_acmpeq = new OpCode(OpCodeValue.if_acmpeq, OpCodeMode.Branch_2, OpCodeModeWide.Unused, true);

                public static OpCode if_acmpne = new OpCode(OpCodeValue.if_acmpne, OpCodeMode.Branch_2, OpCodeModeWide.Unused, true);
                ...
                public static OpCode tableswitch = new OpCode(OpCodeValue.tableswitch, OpCodeMode.Tableswitch, OpCodeModeWide.Unused, true);

                public static OpCode lookupswitch = new OpCode(OpCodeValue.lookupswitch, OpCodeMode.Lookupswitch, OpCodeModeWide.Unused, true);
                ...
                public static OpCode getstatic = new OpCode(OpCodeValue.getstatic, OpCodeMode.Constant_2, OpCodeModeWide.Unused, false);

                public static OpCode putstatic = new OpCode(OpCodeValue.putstatic, OpCodeMode.Constant_2, OpCodeModeWide.Unused, false);

                public static OpCode getfield = new OpCode(OpCodeValue.getfield, OpCodeMode.Constant_2, OpCodeModeWide.Unused, false);

                public static OpCode putfield = new OpCode(OpCodeValue.putfield, OpCodeMode.Constant_2, OpCodeModeWide.Unused, false);

                public static OpCode invokevirtual = new OpCode(OpCodeValue.invokevirtual, OpCodeMode.Constant_2, OpCodeModeWide.Unused, false);

                public static OpCode invokespecial = new OpCode(OpCodeValue.invokespecial, OpCodeMode.Constant_2, OpCodeModeWide.Unused, false);

                public static OpCode invokestatic = new OpCode(OpCodeValue.invokestatic, OpCodeMode.Constant_2, OpCodeModeWide.Unused, false);

                public static OpCode invokeinterface = new OpCode(OpCodeValue.invokeinterface, OpCodeMode.Constant_2_1_1, OpCodeModeWide.Unused, false);

                public static OpCode invokedynamic = new OpCode(OpCodeValue.invokedynamic, OpCodeMode.Constant_2_1_1, OpCodeModeWide.Unused, false);

                public static OpCode @new = new OpCode(OpCodeValue.@new, OpCodeMode.Constant_2, OpCodeModeWide.Unused, false);

                public static OpCode newarray = new OpCode(OpCodeValue.newarray, OpCodeMode.Immediate_1, OpCodeModeWide.Unused, false);

                public static OpCode anewarray = new OpCode(OpCodeValue.anewarray, OpCodeMode.Constant_2, OpCodeModeWide.Unused, false);

                public static OpCode arraylength = new OpCode(OpCodeValue.arraylength, OpCodeMode.Simple, OpCodeModeWide.Unused, false);

                public static OpCode athrow = new OpCode(OpCodeValue.athrow, OpCodeMode.Simple, OpCodeModeWide.Unused, false);

                public static OpCode checkcast = new OpCode(OpCodeValue.checkcast, OpCodeMode.Constant_2, OpCodeModeWide.Unused, false);

                public static OpCode instanceof = new OpCode(OpCodeValue.instanceof, OpCodeMode.Constant_2, OpCodeModeWide.Unused, false);

                public static OpCode monitorenter = new OpCode(OpCodeValue.monitorenter, OpCodeMode.Simple, OpCodeModeWide.Unused, false);

                public static OpCode monitorexit = new OpCode(OpCodeValue.monitorexit, OpCodeMode.Simple, OpCodeModeWide.Unused, false);

                public static OpCode wide = new OpCode(OpCodeValue.wide, NormalizedOpCodeValues.nop, OpCodeMode.WidePrefix, OpCodeModeWide.Unused, true);

                public static OpCode multianewarray = new OpCode(OpCodeValue.multianewarray, OpCodeMode.Constant_2_Immediate_1, OpCodeModeWide.Unused, false);

                public static OpCode ifnull = new OpCode(OpCodeValue.ifnull, OpCodeMode.Branch_2, OpCodeModeWide.Unused, true);

                public static OpCode ifnonnull = new OpCode(OpCodeValue.ifnonnull, OpCodeMode.Branch_2, OpCodeModeWide.Unused, true);

                public static OpCode goto_w = new OpCode(OpCodeValue.goto_w, NormalizedOpCodeValues.@goto, OpCodeMode.Branch_4, OpCodeModeWide.Unused, true);

                public static OpCode jsr_w = new OpCode(OpCodeValue.jsr_w, NormalizedOpCodeValues.jsr, OpCodeMode.Branch_4, OpCodeModeWide.Unused, true);
