...
namespace JavaCompiler.Tests.Compilers.Methods.Expressions
{
    ...
    public class InnerNewCompilerTest
    {
        ...
        {
            InnerNewNode node = null; // TODO: Initialize to an appropriate value
            InnerNewCompiler target = new InnerNewCompiler(node);
        ...
        {
            InnerNewCompiler target = new InnerNewCompiler(null); // TODO: Initialize to an appropriate value
