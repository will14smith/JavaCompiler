...
namespace JavaCompiler.Tests.Compilers.Methods.Expressions
{
    ...
    public class UnaryOtherCompilerTest
    {
        ...
        {
            UnaryOtherNode node = null; // TODO: Initialize to an appropriate value
            UnaryOtherCompiler target = new UnaryOtherCompiler(node);
        ...
        public void CompileTest()
        {
            ...
            UnaryOtherCompiler target = new UnaryOtherCompiler(null); // TODO: Initialize to an appropriate value
