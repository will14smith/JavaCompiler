...
namespace JavaCompiler.Tests
{
    ...
    public class ArrayInitialiserCompilerTest
    {
        ...
        {
            ArrayInitialiserNode_Accessor node = null; // TODO: Initialize to an appropriate value
            ArrayInitialiserCompiler_Accessor target = new ArrayInitialiserCompiler_Accessor(node);
        ...
        public void CompileTest()
        {
            ...
            ArrayInitialiserCompiler_Accessor target = new ArrayInitialiserCompiler_Accessor(param0); // TODO: Initialize to an appropriate value
