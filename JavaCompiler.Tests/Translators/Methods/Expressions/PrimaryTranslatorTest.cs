...
namespace JavaCompiler.Tests.Translators.Methods.Expressions
{
    ...
    public class PrimaryTranslatorTest
    {
        ...
        public void PrimaryTranslatorConstructorTest()
        {
            ...
            PrimaryTranslator target = new PrimaryTranslator(node);
        ...
        public void WalkTest()
        {
            ...
            PrimaryTranslator target = new PrimaryTranslator(null); // TODO: Initialize to an appropriate value
            PrimaryNode expected = null; // TODO: Initialize to an appropriate value
            PrimaryNode actual;
            actual = target.Walk();
