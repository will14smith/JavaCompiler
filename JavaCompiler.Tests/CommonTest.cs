...
namespace JavaCompiler.Tests
{
    ...
    public class CommonTest
    {
        ...
        public void CastByteTest()
        {
            Class stackType = null; // TODO: Initialize to an appropriate value
            ByteCodeGenerator generator = null; // TODO: Initialize to an appropriate value
            Common_Accessor.CastByte(stackType, generator);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
        ...
        [TestMethod()]
        [DeploymentItem("JavaCompiler.dll")]
        public void CastCharTest()
        {
            Class stackType = null; // TODO: Initialize to an appropriate value
            ByteCodeGenerator generator = null; // TODO: Initialize to an appropriate value
            Common_Accessor.CastChar(stackType, generator);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }

        /// <summary>
        ///A test for CastDouble
        ///</summary>
        [TestMethod()]
        [DeploymentItem("JavaCompiler.dll")]
        public void CastDoubleTest()
        {
            Class stackType = null; // TODO: Initialize to an appropriate value
            ByteCodeGenerator generator = null; // TODO: Initialize to an appropriate value
            Common_Accessor.CastDouble(stackType, generator);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }

        /// <summary>
        ///A test for CastFloat
        ///</summary>
        [TestMethod()]
        [DeploymentItem("JavaCompiler.dll")]
        public void CastFloatTest()
        {
            Class stackType = null; // TODO: Initialize to an appropriate value
            ByteCodeGenerator generator = null; // TODO: Initialize to an appropriate value
            Common_Accessor.CastFloat(stackType, generator);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
        ...
        public void CastIntTest()
        {
            Class stackType = null; // TODO: Initialize to an appropriate value
            ByteCodeGenerator generator = null; // TODO: Initialize to an appropriate value
            Common_Accessor.CastInt(stackType, generator);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
        ...
        public void CastLongTest()
        {
            Class stackType = null; // TODO: Initialize to an appropriate value
            ByteCodeGenerator generator = null; // TODO: Initialize to an appropriate value
            Common_Accessor.CastLong(stackType, generator);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }

        /// <summary>
        ///A test for CastPrimative
        ///</summary>
        [TestMethod()]
        [DeploymentItem("JavaCompiler.dll")]
        public void CastPrimativeTest()
        {
            Class stackType = null; // TODO: Initialize to an appropriate value
            Class requiredType = null; // TODO: Initialize to an appropriate value
            ByteCodeGenerator generator = null; // TODO: Initialize to an appropriate value
            Common_Accessor.CastPrimative(stackType, requiredType, generator);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }

        /// <summary>
        ///A test for CastShort
        ///</summary>
        [TestMethod()]
        [DeploymentItem("JavaCompiler.dll")]
        public void CastShortTest()
        {
            Class stackType = null; // TODO: Initialize to an appropriate value
            ByteCodeGenerator generator = null; // TODO: Initialize to an appropriate value
            Common_Accessor.CastShort(stackType, generator);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
